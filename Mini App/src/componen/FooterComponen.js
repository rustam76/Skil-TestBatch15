              ...
              <div className="navi">
                <li>
                  <a href="#">
                    <img
                      className="bloks"
                      src="https://kotakode.com/static/media/block71.f06f3442.svg"
                      alt=""
                    />
                  </a>
                </li>
                <li>
                    ...
                    <a href="#" className="">
                      <img
                        className="google"
                        src="https://kotakode.com/static/media/Google_for_Startups_logo.3a4b3b10.svg"
                        alt=""
                      />
                    </a>
